 ...
 */
@NonNullByDefault
public class AirTouch4ZoneHandler extends BaseThingHandler {

    private final Logger logger = LoggerFactory.getLogger(AirTouch4ZoneHandler.class);

    private @Nullable AirTouch4Configuration config;

    public AirTouch4ZoneHandler(Thing thing) {
        super(thing);
    }
